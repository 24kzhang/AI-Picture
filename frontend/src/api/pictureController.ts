...
/** getVectorHealth GET /api/picture/vector/health */
export async function getVectorHealthUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean_>('/api/picture/vector/health', {
    method: 'GET',
    ...(options || {}),
  })
}
...
/** createPictureAiEditTask POST /api/picture/ai_edit/create_task */
export async function createPictureAiEditTaskUsingPost(
  body: API.CreatePictureAiEditTaskRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseCreateOutPaintingTaskResponse_>(
    '/api/picture/ai_edit/create_task',
    {
      method: 'POST',
...
/** getPictureAiEditTask GET /api/picture/ai_edit/get_task */
export async function getPictureAiEditTaskUsingGet(
  params: API.getPictureAiEditTaskUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseGetOutPaintingTaskResponse_>(
    '/api/picture/ai_edit/get_task',
    {
      method: 'GET',
      params: {
        ...params,
