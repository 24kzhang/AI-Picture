...
/** getUserByIdVO GET /api/user/get/vo */
export async function getUserByIdVoUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getUserByIdVOUsingGETParams,
  options?: { [key: string]: any }
) {
...
export async function healthUsingGet(options?: { [key: string]: any }) {
  return request<API.BaseResponseString_>('/api/user/health', {
    method: 'GET',
    ...(options || {}),
  })
}
